...
const testimonials = [
  {
    quote:
      '"HuzzHub has significantly improved my sigma rizz levels."',
  ...
  {
    quote:
      '"After trying to get on the winter arc, it didnt work. I joined HuzzHub. Idk how they did it but after using huzzhub my rizz levels are off the charts."',
    name: "Ligma Jones",
  ...
  {
    quote:
      '"Lets just say im a lot more chill now, im a huzz magnet!"',
    name: "Jenny Rizzo",
  ...
  {
    quote:
      '"Hawktuah is a thing of the past, HuzzHub is the future."',
    name: "Spitton Datt Faang IV ",
    role: "Ex-Rizz Consultant @ RizzCo Global",
    logoSrc: "favicon.ico",
    avatarSrc: "chillguy3.png",
  },
  {
    quote:
      '"Salsa y picante! HuzzHub took my rizz to the next level. ¡Nos fuimos! Wazaaahhhhhhh"',
    name: "Don Pollo ",
    role: "King of Ohio",
    logoSrc: "favicon.ico",
